...
// 标签列表（按 TMDB 分类定义，与 tmdb.js 的 TMDB_TAG_TO_QUERY 映射一一对应）
let defaultMovieTags = ['热门', '最新', '高分', '动作', '冒险', '科幻', '喜剧', '爱情', '恐怖', '悬疑', '剧情', '动画', '纪录', '华语', '欧美', '韩国', '日本'];
let defaultTvTags = ['热门', '最新', '剧情', '喜剧', '动作冒险', '科幻奇幻', '动画', '纪录', '真人秀', '美剧', '英剧', '韩剧', '日剧', '国产剧', '港剧'];
