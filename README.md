# OpenPlay - 免费在线视频搜索与观看平台

<div align="center">
  <img src="image/logo.png" alt="OpenPlay Logo" width="120">
  <br>
  <p><strong>欢迎来到观影净土</strong></p>
</div>

## 📺 项目简介

OpenPlay 是一个轻量级、免费的在线视频搜索与观看平台，提供来自多个视频源的内容搜索与播放服务。无需注册，即开即用，支持多种设备访问。项目结合了前端技术和后端代理功能，可部署在支持服务端功能的各类网站托管服务上。**项目门户**： [libretv.is-an.org](https://libretv.is-an.org)
...
选择以下任一平台，点击一键部署按钮，即可快速创建自己的 OpenPlay 实例：
...
首次访问 OpenPlay 时，以下功能的默认状态：
- 黄色内容过滤：启用
- 分片广告过滤：启用
- 豆瓣热门推荐：关闭（可在设置面板中手动启用）


### API兼容性

OpenPlay 支持标准的苹果 CMS V10 API 格式。添加自定义 API 时需遵循以下格式：
...
OpenPlay 仅作为视频搜索工具，不存储、上传或分发任何视频内容。所有视频均来自第三方 API 接口提供的搜索结果。如有侵权内容，请联系相应的内容提供方。
